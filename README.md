...
This web application has been developed using HTML,CSS and Javascript and uses openweather API to present current weather/temp data for the hundreds of cities across the globe.
